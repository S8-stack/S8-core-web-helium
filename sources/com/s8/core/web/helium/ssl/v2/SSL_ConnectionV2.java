 ...
 * @author pc
 */
public abstract class SSL_ConnectionV2 extends RxConnection {
	 ...
	 * 
	 */
	public SSL_ConnectionV2(SocketChannel channel) throws IOException {
		super(channel);
	}
	...
	@Override
	public abstract SSL_InboundV2 getInbound();

	@Override
	public abstract SSL_OutboundV2 getOutbound();
