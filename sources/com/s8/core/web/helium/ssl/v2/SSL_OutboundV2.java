 ...
 *
 */
public abstract class SSL_OutboundV2 extends RxOutbound {
	 ...
	 * @param channel
	 */
	public SSL_OutboundV2(SSL_WebConfiguration configuration) {
	...
	class Flow {
		...
		public SSL_Connection getConnection() { 
			return SSL_OutboundV2.this.getConnection();
		}
